    ...
    <main className="relative min-h-screen w-full select-none bg-transparent overflow-x-clip">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <motion.button
          ...
          onClick={() => router.back()}
          className="fixed bottom-6 left-6 z-50 inline-flex items-center gap-2.5 text-cyan-400/80 hover:text-cyan-300 font-orbitron font-black text-xs md:text-sm tracking-widest transition-all duration-300 group cursor-pointer bg-cyan-950/60 backdrop-blur-md px-5 py-2.5 rounded-full border border-cyan-500/20 hover:border-cyan-400/40 hover:shadow-[0_0_15px_rgba(0,242,254,0.15)]"
        >
          <ArrowLeft
            size={14}
