...
const day1Schedule: ScheduleItem[] = [
  ...
  { event: "X-KHO", subtitle: "Kho-Kho (Boys)", venue: "Senior School Back field", time: "10:30 - 1:30" },
];
...
const day2Schedule: ScheduleItem[] = [
  ...
  { event: "X-CALIBRE", subtitle: "Debate (POOL2)", venue: "Fr. Bruylants Hall", time: "8:30 - 11:30" },
  { event: "X-60", subtitle: "One Minute to Fame", venue: "Fr. Bruylants Hall", time: "12:00 - 2:30" },
  { event: "X-ACT", subtitle: "Ad Spoof", venue: "Primary Section Stage", time: "8:30 - 11:30" },
  { event: "X-RAGA", subtitle: "Eastern Music", venue: "Primary Section Stage", time: "12:00 - 2:30" },
  { event: "X-TRAVAGANCE", subtitle: "Western Dance", venue: "Primary Section Stage", time: "4:00 - 6:30" },
  { event: "X-CALIBRE", subtitle: "Debate (POOL1)", venue: "Fr. Sassel Hall", time: "8:30 - 11:30" },
  { event: "X-QUIZITE", subtitle: "Quiz", venue: "Fr. Sassel Hall", time: "12:30 - 3:00" },
  { event: "X-HOOP", subtitle: "Basketball (Girls & Boys)", venue: "Basketball Court", time: "8:30 - 3:00" },
  { event: "X-BID", subtitle: "Cricket Auction", venue: "Reading Room", time: "8:30 - 2:00" },
  { event: "X-NEGOTIUM", subtitle: "Business Event", venue: "Xavier Hall", time: "8:30 - 1:30" },
  { event: "X-GOLPO", subtitle: "Bengali Story telling", venue: "Xavier Hall", time: "2:00 - 4:00" },
  { event: "X-RAPPORTEUR", subtitle: "Vlogging & Journalism", venue: "School Campus", time: "8:30 - 6:00" },
  { event: "X-PIXEL", subtitle: "Photography", venue: "School Campus", time: "8:30 - 2:00" },
  { event: "X-HUNT", subtitle: "Treasure Hunt", venue: "School Campus", time: "10:00 - 12:00" },
];
...
const day3Schedule: ScheduleItem[] = [
  ...
  { event: "X-CHOLOCHITRO", subtitle: "Bengali Short Film", venue: "Xavier Hall", time: "11:00 - 2:00" },
  { event: "X-KALA", subtitle: "Eastern Dance", venue: "Fr. Depelchin Auditorium", time: "8:30 - 11:30" },
  { event: "X-VIBRANCE", subtitle: "Ethnic Display", venue: "Fr. Depelchin Auditorium", time: "12:00 - 2:00" },
  { event: "X-TEMPORE", subtitle: "Extempore", venue: "Fr. Sassel Hall", time: "8:30 - 10:30" },
  { event: "X-CALIBRE", subtitle: "Debate (Final)", venue: "Fr. Sassel Hall", time: "11:30 - 1:30" },
  { event: "CLOSING CEREMONY", venue: "Fr. Depelchin Auditorium", time: "3:30 - 6:00" },
];
