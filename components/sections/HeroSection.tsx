...
export default function HeroSection() {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-screen flex flex-col justify-center items-center text-center px-6 md:px-8 bg-transparent pt-24 md:pt-20 pb-16 overflow-hidden"
    >
      <motion.div
      ...
      >
        <motion.div
          ...
          className="flex flex-col items-center mt-16 md:mt-12 mb-0 text-center px-4 z-10"
        >
          ...
          <span className="font-mono-custom text-xs xs:text-sm sm:text-sm md:text-base text-white/80 tracking-[0.3em] uppercase mt-1 xs:mt-2">
            PRESENTS
          </span>
        </motion.div>
        ...
        <motion.div
          variants={itemVariants}
          className="font-seaweed text-4xl sm:text-5xl md:text-5xl text-cyan-200 mt-2 tracking-wider whitespace-nowrap"
        >
          epochs of eminence
        </motion.div>
